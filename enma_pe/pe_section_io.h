...
public:
    pe_section_io& align_up(uint32_t factor, bool offset_to_end = true);
    pe_section_io& align_up_offset(uint32_t factor);

    pe_section_io& add_size(uint32_t size, bool offset_to_end = true);
