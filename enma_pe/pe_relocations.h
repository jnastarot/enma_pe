...
public:
    ...
    void get_items_in_segment(std::vector<relocation_item>& relocs, uint32_t segment_rva, uint32_t segment_size);
    bool erase_items_in_segment(uint32_t segment_rva, uint32_t segment_size);
